...
**表 1：不同方法在真实航空发动机数据集上的性能对比（%）**
| 方法 (Method) | F1 分数 (F1 Score) | 精确率 (Precision) | 召回率 (Recall) |
| :--- | :---: | :---: | :---: |
| D3QN | 77.19 ± 3.81 | 80.71 ± 4.15 | 76.75 ± 3.88 |
| DS + D3QN (欠采样) | 68.15 ± 9.26 | 71.05 ± 9.10 | 68.00 ± 9.14 |
| OS + D3QN (过采样) | 74.38 ± 5.07 | 81.20 ± 3.66 | 74.00 ± 4.90 |
| **CCRL (本文方法)** | **84.26 ± 4.62** | **87.19 ± 4.34** | **84.00 ± 4.77** |
